/*
# Fix user login view and policies

1. Changes
   - Recreate recent_user_logins view with SECURITY INVOKER
   - Fix type casting issues between UUID and bigint in policies
   - Add proper comments to the view

2. Security
   - Ensure RLS is enabled on user_sessions table
   - Create policy to restrict access to admin users and users viewing their own sessions
*/
